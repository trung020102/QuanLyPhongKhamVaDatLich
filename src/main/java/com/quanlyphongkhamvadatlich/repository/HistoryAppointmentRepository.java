...
//    @Query("SELECT p FROM PatientRecord p WHERE p.createdAt BETWEEN :startDate AND :endDate")
//    public List<PatientRecord> getPatientRecordByDates(@Param("startDate") Date startDate, @Param("endDate") Date endDate);
